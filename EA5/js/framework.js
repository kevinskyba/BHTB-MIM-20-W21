...
class Model {
    ...
    move_to(x, y, z) {
        glMatrix.vec3.set(this._position, x, y, z)
    }
    ...
    update(dt, t) {
        this._model_matrix = glMatrix.mat4.create();
        glMatrix.mat4.translate(this._model_matrix, this._model_matrix, this._position);
        this.on_update(dt, t);
    }
...
class Camera {
    ...
    look_at(x, y, z) {
        glMatrix.vec3.set(this._target, x, y, z)
    }
